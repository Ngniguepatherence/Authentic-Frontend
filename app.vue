...
onMounted(()=>{
  ...
  store.active = route.fullPath
})

 useHead({
    title: 'Authentic',
    meta: [
       { name: 'Authentic, a digital platform, addresses the prevalence of fake communications in Cameroon by using advanced digital signature technology to ensure the authenticity of documents.', content: 'DocSign' },
    ],
